...
expected=[f'https://alvaro-menezes.com/apps/{slug}.html' for slug in ('gfr','tirads','hepfe','orads','nlung')]
...
print(f'PASS: {len(parsed)} HTML pages; structure, headings, anchors, local assets, hashes and five original app links.')
